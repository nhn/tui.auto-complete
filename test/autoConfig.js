var Default = {
  ...
  subQuerySet: [['key1', 'key2', 'key3'], ['dep1', 'dep2', 'dep3'], ['ch1', 'ch2', 'ch3'], ['cid']],
  ...
  actions: ['http://www.fashiongo.net/catalog.aspx', 'http://www.fashiongo.net/search2.aspx'],

  // 컬렉션 타입별 추가 스테틱한 옵션들을 설정
  staticParams: ['qt=ProductName', 'at=TEST,bt=ACT'],

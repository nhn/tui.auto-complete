var Default = { // 설정용가능한 항목을 모두 설정한 config
    ...
    'listConfig': {
        ...
        '3': {
            'template': 'srch_in_static_department',
            'subQuerySet' : 3,
            'action': 1
        },
        '4': {
    ...
    'template' :  {
        department:    {
            ...
            '<span class="slot-field">Category</span>' +
            '</li>',
            attr: ['subject']
        },
        srch : {
    ...
    'actions': [
        "http://dev.www.fashiongo.net:8080/Catalog",
        "http://dev.www.fashiongo.net:8080/Search",
        "http://dev.www.fashiongo.net:8080/Search/Vendor"
    ],
    ...
    // 자동완성API url
    //'searchUrl' : 'http://10.24.136.172:10011/ac',
    'searchUrl' : 'http://4.59.49.27:10011/ac',
...
var Plane = { // 필수 항목만 나열한 config
    ...
    // 자동완성API url
    'searchUrl' : 'http://112.175.29.102:10011/ac',
